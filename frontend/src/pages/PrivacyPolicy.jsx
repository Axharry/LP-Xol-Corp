...
export const PrivacyPolicy = () => {
  ...
  const privacyContent = {
    ...
    lastUpdated: { en: "Last Updated: March 2026", id: "Terakhir Diperbarui: Maret 2026" },
    intro: {
      ...
      <div className="mx-auto max-w-4xl px-6 py-12 md:py-16">
        <div className="space-y-8">
          ...
          <div className="border-b border-gray-200 pb-8">
            <h1 className="text-4xl font-bold text-[#1A1A1A] md:text-5xl" data-testid="privacy-policy-title">
              {t(privacyContent.title)}
            </h1>
            <p className="mt-3 text-sm text-[#6C757D]" data-testid="privacy-policy-date">
          ...
          {privacyContent.sections.map((section, index) => (
            <div key={index} className="space-y-4">
              <h2 className="text-2xl font-semibold text-[#1A1A1A]" data-testid={`privacy-section-${index + 1}-title`}>
                {t(section.title)}
              </h2>
              <div className="space-y-3">
                {t(section.content).map((paragraph, pIndex) => (
                  <p key={pIndex} className="text-base leading-relaxed text-[#6C757D] whitespace-pre-line">
                    {paragraph}
                  </p>
                ))}
              </div>
          ...
          <div className="border-t border-gray-200 pt-8">
            <Button
              onClick={() => navigate("/")}
              className="rounded-sm bg-[#D90429] text-white hover:bg-[#EF233C]"
